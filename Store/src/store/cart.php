    ...
    <div class="row g-5">
      <div class="col order-md-last">
        <h4 class="d-flex justify-content-between align-items-center mb-3">
          ...
          else if(isset($_POST["updateQuant"]))
          {
            $id = $_POST["inpId"];
            // echo $id ;
            // die();
            ...
            <tr>
              ...
              foreach($_SESSION["cart"] as $k=> $v)
              {
                ...
                <td><form action="" method="POST">
                    ...
                    <input type="submit" class="btn btn-secondary ms-1 w-20" name="updateQuant" value="update">
                    </td>
                    <td></form>
                    <form action="" method="POST">
                    <input type="hidden" name="delKey" value='.$k.'>
                    <input type="submit" class="btn btn-danger ms-1 w-20" name="delete" value="DELETE">
                    </td>
                    </form>
                <td>$'.$tPrice.'</td>
            </tr>';
