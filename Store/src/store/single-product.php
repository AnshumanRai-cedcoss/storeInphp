...
if (isset($_POST["submit"])) {
    $id=$_POST["pro_id"];
    $stmt = App\DB::getInstance()->prepare("SELECT * FROM products INNER JOIN category 
    WHERE products.category_id=category.category_id AND products.product_id='$id'");
    $stmt->execute();
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                ...
                <?php foreach ($stmt->fetchAll() as $k => $v) {
                    ...
                    src="../images/<?php echo $v["product_image"]?>" alt="..." /></div>
                    <div class="col-md-6">
